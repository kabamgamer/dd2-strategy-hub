<template>
    <svg xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 256 512"><!-- Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/freøøe Copyright 2024 Fonticons, Inc. -->
        <path
            fill="currentColor"
